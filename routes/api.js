...
router.get("/sendtoaddress/:addr/:amount", (req, res) => {
  //bcrt1q7laksvall9vc6yt8xmhs6r63fmxetxg3ujaps2
	var dataString = `{"jsonrpc": "1.0", "id": "curltext", "method": "sendtoaddress", "params": ["${req.params.addr}", ${req.params.amount}, "donation", "seans outpost"]}`
